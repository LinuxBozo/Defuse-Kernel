...
mDNIe_data_type mDNIe_Video[]= 
{
	...
	END_SEQ, 0x0000,
#else
	0x0084,0x0040, //algorithm selection+pcc + mcm
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0ff0, //de 127, ce off
	0x00ac,0x00e7, //skin detect off, cs 512
	0x00b4,0x0001, //de th.
	0x00c0,0x0400, //PCC skin
	0x00c4,0x7200, //    cb
	0x00c8,0x008d, //    cr
	0x00d0,0x0100, //    strength. 3
	END_SEQ, 0x0000,
#endif
};
...
mDNIe_data_type mDNIe_Camera[]= 
{
	0x0084,0x0040, //algorithm selection + mcm
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0010, //de 0, ce off
...
mDNIe_data_type mDNIe_Camera_Outdoor_Mode[]= 
{
	0x0084,0x0090, //algorithm selection + ove
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0010, //de 127, ce off
...
mDNIe_data_type mDNIe_UI[]= 
{
	...
	0x0098,0x005c, //simplicity th.
	0x009c,0x0ff0, //de 127, ce off
	0x00ac,0x0085, //skin detect off, cs 512
	0x00b4,0x0180, //de th.
	0x00c0,0x0400,
	0x00c4,0x7200,
	0x00c8,0x008d,
...
mDNIe_data_type mDNIe_Video_Warm[]= 
{
	...
	END_SEQ, 0x0000,
#else
	0x0084,0x0020, //algorithm selection+pcc + mcm
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0ff0, //de 127, ce off
	0x00ac,0x0000, //skin detect off, cs 512
	0x00b4,0x0001, //de th.
	0x0120,0x0028, //MCM 10000K
	0x0138,0x7600, //cb 0
	0x0140,0x0090, //cr 0
	END_SEQ, 0x0000,
#endif
...
mDNIe_data_type mDNIe_Video_WO_Mode[]= 
{
	0x0084,0x00b0, //algorithm selection+pcc + mcm
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0ff0, //de 127, ce off
...
mDNIe_data_type mDNIe_Video_CO_Mode[]= 
{
	0x0084,0x00b0, //algorithm selection + mcm
	0x0090,0x0000, //decontour th.
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0ff0, //de 127, ce off
